...
| `-as`, `--ascii`                                 | Use ASCII characters or full block unicode character to represent pixels                                                      |
...
| `-nfs`, `--no-frame-sync`                        | Disables frame sync, will output the next frame immediately                                                                   |
